...
export const EXPERIENCES = [
  {
    ...
    highlights: ['Sistemas SaaS em produção', '99.8% uptime', '+50 automações entregues'],
  ...
  },
  {
    ...
    technologies: ['Figma', 'Adobe Suite', 'Illustrator', 'Photoshop', 'Canva', 'InDesign'],
  },
  {
  ...
  },
  {
    ...
    highlights: ['Suporte L2', 'Manutenção de bases', 'Segurança da informação'],
