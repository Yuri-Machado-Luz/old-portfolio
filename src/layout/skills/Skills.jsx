      ...
      <Container size="lg">
        ...
        <AnimatedSection animation="fadeUp">
          ...
          <p className="text-main-white/70 mb-12 max-w-2xl">
            Stack técnico + experiência em processos e gestão. Background híbrido que permite
            entender tanto o código quanto as pessoas que vão usar.
          </p>
        </AnimatedSection>
        ...
        <div className="mb-16">
          <AnimatedSection animation="fadeUp" delay={0.1}>
            <h3 className="text-main-white mb-6 text-xl font-semibold">Competências Técnicas</h3>
          </AnimatedSection>
        ...
        <div className="mb-16">
          <AnimatedSection animation="fadeUp" delay={0.2}>
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-main-white text-xl font-semibold">Experiência Profissional</h3>
            </div>
          </AnimatedSection>
                ...
                <Card variant="glass" hover className="p-6">
                  <div className="flex flex-col gap-4 md:flex-row">
                    ...
                    <div className="flex-1">
                      <h4 className="text-main-white mb-1 text-lg font-semibold">{exp.role}</h4>
                      ...
                      <div className="mb-3 flex flex-wrap gap-2">
                        {exp.highlights.map((highlight, hIndex) => (
                          <Badge key={hIndex} variant="secondary" size="xs" className="opacity-80">
                            {highlight}
                          </Badge>
                        ))}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, tIndex) => (
                          <Badge key={tIndex} variant="outline" size="xs" className="opacity-60">
                            {tech}
                          </Badge>
                        ))}
                      </div>
        ...
        <div>
          <AnimatedSection animation="fadeUp" delay={0.4}>
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-main-white text-xl font-semibold">Formação</h3>
            </div>
          </AnimatedSection>
            ...
            {EDUCATION.map((edu, index) => (
              <FadeIn key={index} delay={0.5 + index * 0.1}>
                <Card variant="glass" className="p-6">
                  <Card.Body>
                    <h4 className="text-main-white mb-2 text-base font-semibold">{edu.degree}</h4>
