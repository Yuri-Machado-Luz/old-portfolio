  ...
  return (
    <>
      <Motion.nav
        ...
        style={{
          background: isScrolled ? 'rgba(26, 26, 26, 0.20)' : 'rgba(26, 26, 26, 0.40)',
          borderColor: isScrolled ? 'rgba(255, 0, 64, 0.05)' : 'rgba(140, 140, 140, 0.05)',
      ...
      >
        ...
        >
          ...
          >
            YUMA
            <span className="text-pri inline-block animate-pulse text-5xl/0">.</span>
          </a>
        </Motion.h2>

        {/* Menu */}
        <NavMenu className="relative" activeLink={activeLink} handleActiveLink={handleActiveLink} />
      </Motion.nav>
      <div className="h-28" />
    </>
  );
